...
2. [Vagrant](https://www.vagrantup.com) on any platform compatible with the Bento project's [rockylinux-9](https://app.vagrantup.com/bento/boxes/rockylinux-9) image. As of 2022-07-09, that's VirtualBox on x86-64 Linux/macOS/Windows, Parallels on x86-64 macOS VMware Workstation on x86-64 Linux/Windows, or VMware Fusion on x86-64 or Apple Silicon macOS.
